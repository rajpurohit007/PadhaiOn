...
// import { Eye, EyeOff, Mail, Lock, User, Phone, Building2, Check, ArrowRight, Image, GalleryVertical } from "lucide-react"; 
...
//           const errMsg = `File too large: ${largeFiles[0].name}. Max size is ${MAX_FILE_SIZE / (1024 * 1024)}MB.`;
//           setFileError(errMsg);
//           toast.error(errMsg);
//           e.target.value = null; 
...
//       // Don't force login state reset if user just wants to switch context
//       setFormData(prev => ({
//           ...prev,
//           userType: type,
//       }));
...
//     if (!isLogin && formData.userType !== "institution" && formData.password !== formData.confirmPassword) {
//       toast.error("Passwords do not match!");
//       return;
//     }
    
//     // Institution validation
//     if (!isLogin && formData.userType === "institution") {
//         if (!images.thumbnail) {
//             toast.error("Please upload a thumbnail image for your institution.");
//             return;
//         }
//         if (fileError) {
...
//                 // 1. Append all standard form data fields
...
//                 setIsLogin(true); // Switch to login after successful request

//             } else {
//                 // Standard Student Registration (JSON)
...
//           <p className="text-center text-sm text-gray-600">Enter your email to receive an OTP.</p>
//           <div>
//               <label className="block text-sm font-medium text-gray-700 mb-2">Email Address</label>
//               <div className="relative">
//                   <Mail className="absolute left-3 top-1/2 transform -translate-y-1/2 text-gray-400 h-5 w-5" />
//                   <input type="email" name="email" required value={formData.email} onChange={handleInputChange} className="w-full pl-10 pr-4 py-3 border rounded-lg" placeholder="Enter your email" />
//               </div>
//           </div>
//           <button type="submit" disabled={loading} className="w-full bg-blue-600 text-white py-3 rounded-lg font-bold hover:bg-blue-700">{loading ? "Sending..." : "Send OTP"}</button>
//           <button type="button" onClick={() => setView("login")} className="w-full text-blue-600 text-sm mt-2 hover:underline">Back to Login</button>
//       </form>
//   );
...
//                   <input type="text" name="otp" required value={formData.otp} onChange={handleInputChange} className="w-full pl-10 pr-4 py-3 border rounded-lg" placeholder="6-digit OTP" />
//               </div>
//           </div>
//           <div>
//               <label className="block text-sm font-medium text-gray-700 mb-2">New Password</label>
//               <input type="password" name="newPassword" required value={formData.newPassword} onChange={handleInputChange} className="w-full px-4 py-3 border rounded-lg" placeholder="New Password" />
//           </div>
//           <div>
//               <label className="block text-sm font-medium text-gray-700 mb-2">Confirm New Password</label>
//               <input type="password" name="confirmPassword" required value={formData.confirmPassword} onChange={handleInputChange} className="w-full px-4 py-3 border rounded-lg" placeholder="Confirm New Password" />
//           </div>
//           <button type="submit" disabled={loading} className="w-full bg-green-600 text-white py-3 rounded-lg font-bold hover:bg-green-700">{loading ? "Resetting..." : "Reset Password"}</button>
//       </form>
//   );
//   // --- Registration Form ---
...
//           {/* General Fields (Name, Email, Phone) */}
//           <div>
...
//                   placeholder={formData.userType === 'institution' ? "Institution Name" : "Enter your full name"}
//                 />
//               </div>
//             </div>
//             <div>
...
//           {/* Institution Specific Fields (only when registering institution) */}
...
//                           <input type="number" name="totalStudents" required value={formData.totalStudents} onChange={handleInputChange} className="w-full px-4 py-3 border rounded-lg" />
//                       </div>
//                       <div>
//                           <label className="block text-sm font-medium text-gray-700 mb-2">Institution Category</label>
...
//                           <input type="text" name="location" required value={formData.location} onChange={handleInputChange} className="w-full px-4 py-3 border rounded-lg" />
//                       </div>
//                       <div>
//                           <label className="block text-sm font-medium text-gray-700 mb-2">City</label>
//                           <input type="text" name="city" required value={formData.city} onChange={handleInputChange} className="w-full px-4 py-3 border rounded-lg" />
//                       </div>
//                   </div>
//                   <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
//                       <div>
//                           <label className="block text-sm font-medium text-gray-700 mb-2">Established Year</label>
//                           <input type="number" name="established" required value={formData.established} onChange={handleInputChange} className="w-full px-4 py-3 border rounded-lg" />
//                       </div>
//                       <div>
//                           <label className="block text-sm font-medium text-gray-700 mb-2">Specialization</label>
//                           <input type="text" name="specialization" required value={formData.specialization} onChange={handleInputChange} className="w-full px-4 py-3 border rounded-lg" />
//                       </div>
//                   </div>
//                   <div>
//                       <label className="block text-sm font-medium text-gray-700 mb-2">Description</label>
//                       <textarea name="description" required value={formData.description} onChange={handleInputChange} rows={3} className="w-full px-4 py-3 border rounded-lg" />
//                   </div>
//               </>
//           )}

//           {/* Password Fields (for Student and Login) */}
//           {(isLogin || (!isLogin && formData.userType === "student")) && (
//               <>
//                   <div>
...
//                 {view === 'login' ? "Welcome Back" : view === 'register' ? "Join PadhaiOn" : "Reset Password"}
//             </h2>
...
//           {/* Type Toggles - Hidden in Forgot Password flows */}
...
//                         formData.userType === 'student' ? 'bg-blue-600 text-white shadow-md' : 'bg-gray-200 text-gray-700 hover:bg-gray-300'
//                     }`}
//                 >
//                     I am a Student
//                 </button>
...
//                         formData.userType === 'institution' ? 'bg-blue-600 text-white shadow-md' : 'bg-gray-200 text-gray-700 hover:bg-gray-300'
//                     }`}
//                 >
